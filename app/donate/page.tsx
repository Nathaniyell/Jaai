...
export default function DonatePage() {
  const supportCards = [
    ...
    },
    {
      ...
      description: "Educate communities to foster acceptance and reduce stigma.",
      icon: School,
    },
    {
      title: "Family Support",
      description: "Equip families and caregivers with resources and knowledge.",
      icon: Users,
    },
  ];
  ...
  return (
    <SectionWrapper>
      <div className="mx-auto max-w-4xl space-y-8">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-slate-900">Why Your Gift Matters</h2>
          <p className="mt-3 text-slate-600">Every donation, big or small, helps us sustain critical programs and reach more communities in need.</p>
        </div>
        ...
        <div className="text-center w-full">
          <Link href={whatsappDonateUrl} target="_blank" rel="noopener noreferrer" aria-label="Donate via WhatsApp">
