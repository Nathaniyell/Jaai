...
export const impactStories: Story[] = [
  ...
  {
    title: "Caregiver Confidence Through Training",
    excerpt:
      "Workshops helped caregivers build routines, communication strategies, and stronger emotional resilience.",
    program: "Parent and Caregiver Workshops",
  },
];
